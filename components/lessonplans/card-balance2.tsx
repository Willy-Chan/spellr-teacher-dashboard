      ...
      <CardBody className="py-5">
        <div className="flex gap-2.5">
          ...
          <div className="flex flex-col">
            <span className="text-xl">Reading Lesson</span>
            <span className="text-default-900 text-xs">+60 pages</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div>
            ...
            <span className="text-default-900 text-xs">xyz</span>
          </div>
          ...
          <div>
            ...
            <span className="text-default-900 text-xs">abc</span>
          </div>
          ...
          <div>
            ...
            <span className="text-default-900 text-xs">def</span>
          </div>
        </div>
      </CardBody>
    </Card>
